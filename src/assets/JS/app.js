...
const rent = [
  ...
  {
    name: 'Propiedad en Santiago de Chile',
    src: './src/assets/img/sale/',
    description: 'Propiedad en zona poniente de Santiago. Servicios a la puerta.',
...
const sale = [
  {
    name: 'Propiedad en la región de United States of Shile',
    src: './src/assets/img/rent/',
    description: 'Propiedad en la región de United States of Shile, servicios cercanos y de todo tipo, lo que quieras.',
    location: 'Av. Shile N° 11001',
    rooms: 3,
    cost: '$800.000',
    smoke: true,
    pets: false
  ...
  {
    name: 'Se vende propiedad en Concepción',
    src: './src/assets/img/rent/',
    description: 'Se vende propiedad en la zona centro sur de Chile, región de Concepción. Santiaguinos, es como su casa.',
    location: 'Av. Plaza de armas N° 9326',
    rooms: 5,
    cost: '$700.000',
    smoke: false,
    pets: true
  ...
  {
    name: 'Propiedad en zona exagerdamente exclusiva',
    src: './src/assets/img/rent/',
    description: 'Propiedad en zona exageradamente exclusiva, más que las que pudo haber comprado el Chapo.',
    location: 'Av. Exageradamente exclusiva N° 111',
    rooms: 3,
    cost: '$500.000',
    smoke: false,
    pets: true
...
const init = async () => {
  renderHouses(rent, rentContainer);
  renderHouses(sale, salesContainer);
};
